...
Fluid::Fluid(double _density, int _numX, int _numY, double _h, double _overRelaxation)
{
    density = _density;
    numX = _numX + 2;
    numY = _numY + 2;
...
{
    int n = numY;
//    #pragma omp parallel for reduction(vec_double_plus : v)
